...
<div class="dropdown-content">
    ...
    <h1 style="font-size:200%;margin-left:40%;margin-top:2%;">Hostel Circle to New Hostels</h1>
...
$sql = "SELECT yes_count, no_count FROM vote_counts2";
    ...
    if ($routeResult && $routeResult->num_rows > 0) {
        ...
        while ($row = $routeResult->fetch_row()) {
            ...
            if ($minutesDifference1 >=5 && $minutesDifference1 <=8 && $hoursDifference1 == 0 && $startDateTime >= $endDateTime1) {
                ...
                $yes_count = 0;
                $no_count = 0;
                $sql = "UPDATE vote_counts2 SET yes_count = 0, no_count = 0";
                $result = mysqli_query($conn, $sql);
